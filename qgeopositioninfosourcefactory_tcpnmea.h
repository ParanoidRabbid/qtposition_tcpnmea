...
#ifndef QGEOPOSITIONINFOSOURCEFACTORY_tcpnmea_H
#define QGEOPOSITIONINFOSOURCEFACTORY_tcpnmea_H

#include <QObject>
#include <qgeopositioninfosourcefactory.h>

class QGeoPositionInfoSourceFactorytcpnmea : public QObject, public QGeoPositionInfoSourceFactoryV2
{
    Q_OBJECT
